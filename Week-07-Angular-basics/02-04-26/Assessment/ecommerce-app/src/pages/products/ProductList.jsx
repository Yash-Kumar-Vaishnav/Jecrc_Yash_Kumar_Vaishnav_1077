    ...
    <div className="products-page fade-up">
      <div className="products-header">
        <div>
          ...
          <p>{t.products.itemsCount(products.length)}</p>
        </div>
        <div className="products-filters">
          <select className="filter-select">
            <option>{t.products.allCategories}</option>
          ...
          <select className="filter-select">
            <option>{t.products.sortFeatured}</option>
            <option>{t.products.sortLowHigh}</option>
            <option>{t.products.sortHighLow}</option>
